 ...
 * @author erucolindo
 */
public class TabelaKlient extends javax.swing.JFrame {
    ...
    private void selectTableAndWrite()
    {
        ...
        Integer id = null;
        String nazwa = null, imie = null, nazwisko = null,email = null, nr_tel = null, ulica = null, miasto = null; 
        try
        {
            c = DataBaseConnection.openConnection();
            stm = c.createStatement();
            adres_stm = c.createStatement();
            query_result = stm.executeQuery("SELECT * FROM mydb.Klient");
        }
        ...
        try
        {
            ...
            while(query_result.next())
            {
                ...
                id = query_result.getInt("idKlient");
                ...
                try 
                {
                    ...
                    jTable1.setValueAt(ulica, i, 6);
                    miasto = query_adres.getString("Miasto");
                    jTable1.setValueAt(miasto, i, 7);
                }catch(SQLException e)
                {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setFont(new java.awt.Font("Noto Sans", 0, 8)); // NOI18N
        jScrollPane1.setPreferredSize(new java.awt.Dimension(680, 500));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nazwa", "Imię", "Nazwisko", "E-mail", "Nr Tel", "Ulica", "Miasto"
            }
        ) {
        ...
        jTable1.setPreferredSize(new java.awt.Dimension(650, 720));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TabelaKlient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TabelaKlient().setVisible(true);
            }
        });
    }
